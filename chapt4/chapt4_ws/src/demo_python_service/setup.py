...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'face_detect_node_param = demo_python_service.face_detect_node_param:main',
            'face_detect_client_node_param = demo_python_service.face_detect_client_node_param:main',
        ],
    },
)
